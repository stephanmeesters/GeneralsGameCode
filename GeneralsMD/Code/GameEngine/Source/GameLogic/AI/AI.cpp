...
{
	CRC_XFER(xfer, xferReal, m_structureSeconds, "Real");
	CRC_XFER(xfer, xferReal, m_teamSeconds, "Real");
	CRC_XFER(xfer, xferInt, m_resourcesWealthy, "Int");
	CRC_XFER(xfer, xferInt, m_resourcesPoor, "Int");
	CRC_XFER(xfer, xferUnsignedInt, m_forceIdleFramesCount, "UnsignedInt");
	CRC_XFER(xfer, xferReal, m_structuresWealthyMod, "Real");
	CRC_XFER(xfer, xferReal, m_teamWealthyMod, "Real");
	CRC_XFER(xfer, xferReal, m_structuresPoorMod, "Real");
	CRC_XFER(xfer, xferReal, m_teamPoorMod, "Real");
	CRC_XFER(xfer, xferReal, m_teamResourcesToBuild, "Real");
	CRC_XFER(xfer, xferReal, m_guardInnerModifierAI, "Real");
	CRC_XFER(xfer, xferReal, m_guardOuterModifierAI, "Real");
	CRC_XFER(xfer, xferReal, m_guardInnerModifierHuman, "Real");
	CRC_XFER(xfer, xferReal, m_guardOuterModifierHuman, "Real");
	CRC_XFER(xfer, xferUnsignedInt, m_guardChaseUnitFrames, "UnsignedInt");
	CRC_XFER(xfer, xferUnsignedInt, m_guardEnemyScanRate, "UnsignedInt");
	CRC_XFER(xfer, xferUnsignedInt, m_guardEnemyReturnScanRate, "UnsignedInt");
	CRC_XFER(xfer, xferReal, m_alertRangeModifier, "Real");
	CRC_XFER(xfer, xferReal, m_aggressiveRangeModifier, "Real");
	CRC_XFER(xfer, xferReal, m_attackPriorityDistanceModifier, "Real");
	CRC_XFER(xfer, xferReal, m_maxRecruitDistance, "Real");
	CRC_XFER(xfer, xferReal, m_skirmishBaseDefenseExtraDistance, "Real");
	CRC_XFER(xfer, xferReal, m_repulsedDistance, "Real");
	CRC_XFER(xfer, xferBool, m_enableRepulsors, "Bool");
...
void AI::crc( Xfer *xfer )
{
	...
	CRC_XFER_SNAPSHOT(xfer, m_pathfinder, "m_pathfinder");
	...
	while (aiData)
	{
		...
		CRC_XFER(xfer, xferAsciiString, marker, "AsciiString");
		CRC_XFER_SNAPSHOT(xfer, aiData, "aiData");
	...
	for (std::list<AIGroup *>::iterator groupIt = m_groupList.begin(); groupIt != m_groupList.end(); ++groupIt)
	{
		if (*groupIt)
		{
			...
			CRC_XFER(xfer, xferAsciiString, marker, "AsciiString");
		CRC_XFER_SNAPSHOT(xfer, (*groupIt), "groupIt");
		}
	}
